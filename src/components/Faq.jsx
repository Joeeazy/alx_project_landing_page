  ...
  return (
    <section className="section pt-[480px] lg:pt-[280px]">
      <div className="max-w-[768px] mx-auto lg:bg-faq bg-no-repeat bg-custom bg-center lg:h-[1160px] lg:pt-6">
        {/* section title */}
        <div
          className="section-title-group justify-start lg:justify-center -space-x-4 ld:max-w-[540px] mx-auto px-4 lg:px-0 "
          data-aos="fade-up"
          data-aos-offset="300"
          data-aos-delay="200"
        >
          <img className="lg:hidden" src={icon} alt="faq icon" />
